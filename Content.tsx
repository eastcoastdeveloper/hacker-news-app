  ...
  return (
    <div className="content">
      <main ref={mainElem} className={contentPanel ? 'overflow-y-none' : ''}>
        ...
        <div
          id="search-history"
          className={contentPanel ? 'show-panel' : 'hide-panel'}
        >
              ...
              <li key={index}>
                <div>
                  ...
                  <div className="history-results">
                    <a href={val.hits[0].story_url} target="_blank">
                      {val.hits[0].story_title}
                    </a>
                    <a href={val.hits[1].story_url} target="_blank">
                      {val.hits[1].story_title}
                    </a>
                    <a href={val.hits[2].story_url} target="_blank">
                      {val.hits[2].story_title}
                    </a>
                  </div>
                </div>
              </li>
